            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <figure class="mobile-image">
                        <img src="./assets/images/progress-phone.png" alt="">
                    </figure>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 section-padding">
                    ...
                    <div class="space-60"></div>
                    <a href="#" class="bttn-white sq"><img src="./assets/images/apple-icon.png" alt="apple icon"> Apple Store</a>
                    <a href="#" class="bttn-white sq"><img src="./assets/images/play-store-icon.png" alt="Play Store Icon"> Play Store</a>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body row">
        <div class="col-md-7" style="padding: 25px 25px">
            <h3 class="dark-color">Get Products</h3>
            <p>Grab your visitors’ attention and lead them to the most important content.</p>
            <a href="#" class="bttn-white active">Get Now</a>

        </div>
        <div class="col-md-5" style="padding: 25px 25px">
            <img src="./assets/images/12-paper_plane.png" style="width: 175px !important; height: 175px !important;">
        </div>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
